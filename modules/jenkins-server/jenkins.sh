...
server {
    listen 80;
    server_name jenkins.kubeigu.plainandplane.com;
...
sudo certbot --nginx -d jenkins.kubeigu.plainandplane.com --email tdwaws2024@gmail.com --non-interactive --agree-tos --redirect
...
echo "Jenkins is now accessible via https://jenkins.kubeigu.plainandplane.com"
